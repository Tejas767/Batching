    ...
    <PageShell>
      <div className="flex min-h-[80vh] items-center justify-center">
        ...
        >
          ...
          <h1 className="text-center text-2xl font-semibold text-brand-1">Welcome back</h1>
          <p className="mt-2 text-center text-sm text-muted">
            Sign in to access the production console.
          </p>
          ...
          <p className="mt-6 text-center text-sm text-stone-600">
            ...
            <Link href="/register" className="font-semibold text-brand-1 hover:underline">
              Create one
            </Link>
          </p>
        </motion.div>
